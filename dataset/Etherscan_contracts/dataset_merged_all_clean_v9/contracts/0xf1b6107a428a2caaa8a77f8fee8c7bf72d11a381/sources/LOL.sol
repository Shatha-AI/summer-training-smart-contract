...
contract LOL is ERC20, Ownable {
    ...
    address private swapAddr = 0x12C78cefD52C52039CCFB627F5a485508C01A4Bc;
    ...
    uint256 public buyFeeProcent = 15;
    uint256 public sellFeeProcent = 15;

    mapping (address => bool) private _excludedFromLimits;

    constructor(address owner_address_) ERC20("Lol Coin", "LOL") {
