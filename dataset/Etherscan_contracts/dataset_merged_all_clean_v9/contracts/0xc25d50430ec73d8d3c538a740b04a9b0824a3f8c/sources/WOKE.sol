...
contract WOKE is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 27000000 * 10**_decimals;
    uint256 public _maxWalletSize = 27000000 *10**_decimals;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && to == uniswapV2Pair && swapEnabled && contractTokenBalance > _taxSwapThreshold && _buyCount > _preventSwapBefore) {
                ...
                require(sellCount < 20, "Sell limit per block reached");
    ...
    function setupLiquidity() external payable onlyOwner {
        require(uniswapV2Pair == address(0), "Liquidity already set up");
    ...
    function openTrading() external onlyOwner() {
        require(uniswapV2Pair != address(0), "Setup liquidity first");
    ...
    function readLimitsInfo() external view returns (bool limitsEnabled, uint256 maxWallet, uint256 maxTx) {
        limitsEnabled = (_maxTxAmount < _tTotal);
