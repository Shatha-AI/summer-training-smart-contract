...
https://x.com/NerveProtocol
https://www.nerve-protocol.com/
...
contract AS is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Nerve Protocol";
    string private constant _symbol = unicode"NPX";
    ...
    constructor () {
        ...
        _taxWallet = payable(0x3B48F08993DCEF0bC2C84c65227dcf2A0eee4002);
