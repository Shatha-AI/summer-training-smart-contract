...
/*
    The Black Bull charges when everyone else stops believing. The horns stay on ⚫️🐂

    https://theblackbull.vip
    https://x.com/BlackBull_ETH
*/
...
contract ANSEM is ERC20, Ownable {
    ...
    constructor() ERC20(unicode"The Black Bull​", unicode"ANSEM") payable{
