...
contract WCSTARS is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = unicode"World Cup Stars";
    string private constant _symbol = unicode"WCSTARS";
    ...
    uint256 public maximumWalletBalance = 1000000 * (10 ** _decimals);
    uint256 public maximumTransactionSize = 1000000 * (10 ** _decimals);
