...
contract MUMU is ERC20, Ownable {
    ...
    function setMarketingReceiver(address _marketing) external onlyOwner {
        emit MarketingWalletUpdated(_marketing, mumuAddress);
        mumuAddress = _marketing;
    }
     ...
     * @return _mumuAddress The wallet that receives the marketing fees
     */
    function readFeeReceiver()
        external
        view
        returns (address _mumuAddress)
    {
        return (mumuAddress);
    }
    ...
    function swapBack(uint256 amount) private {
        ...
        (success, ) = address(mumuAddress).call{
