...
/**
 * @title ERC20Decimals
 * @dev Extension of ERC20 that adds a storage slot for decimals.
 */
abstract contract ERC20Decimals is ERC20 {
    /**
     * @dev The configured number of decimals.
     */
...
/**
 * @title IPayable
 * @dev Interface for contracts that collect service fees.
 */
interface IPayable {
    /**
     * @dev Processes a service payment.
     *
     * @param serviceName The identifier of the purchased service.
     * @param signature The signature authorizing the payment terms.
     * @param wallet The wallet associated with the purchase.
     */
...
abstract contract ServicePayer {
    /**
     * @dev Pays the service fee to the configured receiver during deployment.
     *
     * @param receiver The contract that receives the payment.
     * @param serviceName The identifier of the purchased service.
     * @param signature The signature authorizing the payment terms.
     * @param wallet The wallet associated with the purchase.
     */
...
contract StandardERC20 is ERC20Detailed, ServicePayer {
    ...
    {
        require(initialOwner_ != address(0), "Initial owner cannot be the zero address");
        require(initialBalance_ > 0, "Initial supply cannot be zero");

        _mint(initialOwner_, initialBalance_);
    }
}
