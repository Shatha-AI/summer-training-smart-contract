...
contract chicky is ERC20, Ownable {
    ...
    uint256 public maxTransactionLimit = 2500000000*10**decimals();
...
function _update(address from, address to, uint256 amount) internal override  virtual  {
    ...
    function disableMaximumTxnLimits() public onlyOwner{
        antiwhale = !antiwhale;
    }

    function setMaximumTxnLimit(uint256 _maxTransactionLimit) public  onlyOwner{
