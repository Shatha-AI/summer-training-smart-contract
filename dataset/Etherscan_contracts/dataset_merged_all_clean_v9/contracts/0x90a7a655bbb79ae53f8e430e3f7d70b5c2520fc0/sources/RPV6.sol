...
// File: RewardV2 Test/RewardPoolV6-draft.sol
...
contract RPV6 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable {
   ...
   */
  function whitelistDistributor(address[] calldata _addressesToWhitelist) external onlyOwner {
  ...
  function changeContributionBatch(uint256[][3] memory _rounds) external onlyOwner {
    rounds = _rounds;
  }
