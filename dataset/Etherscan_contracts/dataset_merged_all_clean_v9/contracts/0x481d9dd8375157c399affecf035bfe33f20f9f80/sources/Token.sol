...
/*
    People ask whether Elon Musk will become the world's first trillionaire.
    They're asking the wrong question.
    The first trillionaire won't be made by cars, social media, or AI. It wasn't. The first trillionaire will be made by asteroid mining. twiceAsteroid Trillionaire is the meme token for that inevitability.

    https://asteroidtrillionaire.wtf
    https://t.me/asttrillionaire
    https://x.com/asttrillionaire
*/
...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Asteroid Trillionaire";
