...
contract WalueAI is IERC20, Ownable {
    ...
    string  private constant _NAME     = "Walue AI";
    ...
    uint256 private constant INITIAL_TAX = 20;
    ...
    uint256 public maxTxAmount   = 40_000_000 * 10 ** _DECIMALS; // 4.0% of supply
    uint256 public maxWalletSize = 40_000_000 * 10 ** _DECIMALS; // 4.0% of supply
    /// @dev Token balance that triggers an auto-swap to ETH.
    uint256 public swapThreshold = 10_000_000 * 10 ** _DECIMALS;  // 1.0% of supply
    ...
    uint256 public constant WALLET_CHANGE_LOCK  = 30 days;    // tax wallet timelock
