...
Mexican axolotl World Cup Mascot - $Axolotl
...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private _initTokenDoubleTransferClick = 3;
    uint256 private _finalTokenDoubleTransferClick = 0;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 1_00_000_000 * 10**_decimals;
    string private constant _name = unicode"Mexican axolotl World Cup Mascot";
    string private constant _symbol = unicode"Axolotl";
