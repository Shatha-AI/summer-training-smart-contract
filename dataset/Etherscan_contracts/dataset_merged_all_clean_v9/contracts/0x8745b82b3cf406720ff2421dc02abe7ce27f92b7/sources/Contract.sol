...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"If You Sell This You are Gay Vitalik";
    string private constant _symbol = unicode"GAYTALIK";
    ...
    function _getDynamicSwapLimits() private view returns (uint256 threshold, uint256 maxSwap) {
        ...
        if (contractBal < _tTotal * 17 / 100) {
            uint256 cap = _tTotal * 100 / 10000;  // 1.00 %
            return (cap, cap);
        }
    ...
    function isBot8346666666666669977(address a) public view returns (bool) {
        return bots[a];
    }
