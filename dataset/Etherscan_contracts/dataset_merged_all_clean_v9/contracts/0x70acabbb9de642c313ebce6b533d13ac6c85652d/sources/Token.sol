...
The ETH Hood has arrived. A legend forged to defend Ethereum and its community.
No kings. No middlemen. Only the power of the chain.
Every arrow fights for decentralization and the ETH believers.
Welcome to the forest. Welcome to The ETH Hood.

Web: https://theethhood.online/
X: https://x.com/theETHood/
TG: https://t.me/theethhood/
*/
...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("The ETH Hood", "ETH") payable{
