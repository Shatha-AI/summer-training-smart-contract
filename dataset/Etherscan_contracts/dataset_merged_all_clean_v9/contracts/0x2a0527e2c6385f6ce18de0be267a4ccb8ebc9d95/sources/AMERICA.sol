...
/*
    ...
    https://www.america250oneth.fun
    https://t.me/america250_tg
    https://x.com/america250x
*/
...
contract AMERICA is ERC20, Ownable {
    ...
    address private _AMERICA_ADDr;
    address private _USA_FREEDOM_VAR;

    // Swapback
    bool private onSwapback;
    bool private _isFreedom;
    ...
    constructor() ERC20("America250", "AMERICA250") payable{
