...
contract Nympheas_1916_19 is ERC721AC, BasicRoyalties, Ownable, OwnableBasic {
     string private _baseTokenURI;
    uint256 public publicMintPrice = 0.038 ether;
    uint256 public constant RESERVED = 8;
    uint256 public MAX_SUPPLY = 68;
    ...
    mapping(address => bool) public minter;
     ...
     constructor(address initialOwner, address royaltyReceiver, uint96 royaltyFeeNumerator, address _minter) ERC721AC("Nympheas, 1916-19", "Nympheas, 1916-19") 
