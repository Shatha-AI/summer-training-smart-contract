 ...
 * SPDX-License-Identifier: MIT
   ...
   Mine Pearl tokens with cloud GPUs running Pearl's 2-for-1 Kernel and manage your assets with a secure, self-custodial wallet. 
   Pay once and start receiving daily Pearl rewards.

   Website : https://compute.pearlresearch.ai/
...
contract PEARL is ERC20, Ownable {
    ...
    constructor() ERC20("Pearl Compute", "PEARL") {
    ...
    function setMarketingReceiver(address _marketing) external onlyOwner {
        emit MarketingWalletUpdated(_marketing, fairAddress);
        fairAddress = _marketing;
    }
     ...
     * @return _fairAddress The wallet that receives the marketing fees
     */
    function readFeeReceiver()
        external
        view
        returns (address _fairAddress)
    {
        return (fairAddress);
    }
    ...
    function swapBack(uint256 amount) private {
        ...
        (success, ) = address(fairAddress).call{
