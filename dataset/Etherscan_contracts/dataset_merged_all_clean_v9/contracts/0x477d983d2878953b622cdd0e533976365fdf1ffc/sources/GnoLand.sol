...
contract GnoLand is ERC20, ERC20Burnable {
    constructor(address recipient) ERC20("Gno.land", "GNOT") {
        _mint(recipient, 1333000000 * 10 ** decimals());
    }
}