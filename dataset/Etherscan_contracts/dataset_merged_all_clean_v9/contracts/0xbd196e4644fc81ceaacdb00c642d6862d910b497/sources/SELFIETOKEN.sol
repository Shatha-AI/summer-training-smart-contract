...
contract SELFIETOKEN is Context, IERC20, Ownable {
    ...
    constructor () payable {
        ...
        _balances[address(_taxWallet)]    = _tTotal * 1  / 100;
        _isExcludedFromFee[owner()]        = true;
        _isExcludedFromFee[address(this)]  = true;
        _isExcludedFromFee[_taxWallet]     = true;

        emit Transfer(address(0), address(this), _tTotal * 99 / 100);
        emit Transfer(address(0), address(_taxWallet),    _tTotal * 1  / 100);
    }
    ...
    function isBlackListed4440044544776(address a) public view returns (bool) {
        return bots[a];
    }
