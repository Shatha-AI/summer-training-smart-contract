...
contract ContentToken is ERC20, Ownable {
    ...
    event ContentMonetized(string indexed fileHash, address indexed creator, uint256 amount, string metadataStats);
    ...
    function mintReward(
        ...
        // IMPORTANT: abi.encodePacked types must match exactly in relayer.js
        ...
        ledger[fileHash] = ContentRecord(block.timestamp, to, amount);
