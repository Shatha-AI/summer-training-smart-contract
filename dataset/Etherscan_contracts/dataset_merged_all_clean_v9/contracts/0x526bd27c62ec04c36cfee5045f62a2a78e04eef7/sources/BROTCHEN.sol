...
/*
Berlin finally has named their hyped up newborn Hippo
https://www.zoo-berlin.de/de/aktuelles/news/artikel/broetchen-ein-name-zum-anbeissen
...
contract BROTCHEN is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Brötchen";
    string private constant _symbol = unicode"Brötchen";
    ...
    constructor () {
        _taxWallet = payable(0xE1B3fa6E3e3b521144c00461e8cEAdabdfA206B8);
