// File: @openzeppelin/contracts-upgradeable@4.9.6/token/ERC20/IERC20Upgradeable.sol
...
// File: @openzeppelin/contracts-upgradeable@4.9.6/utils/AddressUpgradeable.sol
...
// File: @openzeppelin/contracts-upgradeable@4.9.6/proxy/utils/Initializable.sol
...
// File: @openzeppelin/contracts-upgradeable@4.9.6/utils/ContextUpgradeable.sol
...
// File: @openzeppelin/contracts-upgradeable@4.9.6/security/PausableUpgradeable.sol
...
// File: @openzeppelin/contracts-upgradeable@4.9.6/security/ReentrancyGuardUpgradeable.sol
...
// File: RewardV2 Test/RewardPoolV6-draft2.sol
...
contract RPV6 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable {
   ...
   */
  function scheduleClaim(uint256 _claimStart, uint256 noOfTokens, address _saleToken, address _stakingManagerAddress) external onlyOwner returns (bool) {
   ...
   */
  function NewClaimStart(uint256 _claimStart) external onlyOwner returns (bool) {
   ...
   */
  function whitelistDelegator(address[] calldata _addressesToWhitelist) external onlyOwner {
  ...
  function changeContributionData(uint256[][3] memory _rounds) external onlyOwner {
    rounds = _rounds;
  }
   ...
   */
  function setRewardPerSecond(uint256 _timeConstant) external onlyOwner {
   ...
   */
  function updateFromBSD8488408108410184(address[] calldata _users, uint256[] calldata _userDeposits) external onlyOwner {
   ...
   */
  function deployNewStrategy() external {
   ...
   */
  function setCurrentStep2(uint256 _step, uint256 _checkpoint) external onlyOwner {
    currentStep = _step;
   ...
   */
  function setNewEpoch(bool _dynamicTimeFlag) external onlyOwner {
