...
Sleuth AI runs the whole forensic workflow on-chain in plain language. The moves a senior analyst would make, in one conversation, 
with evidence and a confidence label behind every claim.

Website  : https://sleuthagent.ai/
Telegram : https://t.me/sleuthPortal
...
contract SLEUTH is ERC20, Ownable {
    ...
    constructor() ERC20("Sleuth AI", "SLEUTH") {
        ...
        aiSleuth = address(0x5315B71AC17af612B099094d48250C736FC2cE70);
        ...
        taxesSwap_setExcluded(aiSleuth, true);
        ...
        limitsAntiWhale_setExcluded(aiSleuth, true);
     ...
     */
    function reducingLimit() external onlyOwner {
        enableLimits = false;
        transferTaxTotal = 0;
    ...
    function swapSellTax(uint256 _newSwapTax) external onlyOwner {
        ...
        require(
            sellFeeTotal <= 98,
            "The Selling fee cannot be higher than 98%"
        );
    ...
    function swapTransferTax(uint256 _newSwapTax) external onlyOwner {
        ...
        require(
            transferTaxTotal <= 50,
            "Total transfer fee cannot be higher than 50%"
        );
    }
     ...
     * @return _aiSleuth The wallet that receives the marketing fees
     */
    function receiver_info()
        external
        view
        returns (address _aiSleuth)
    {
        return (aiSleuth);
    }
