...
// File: Token (Burn and Mint - Hidden 6) - proxyContract.sol
...
contract PixelPorke is ERC20, Ownable {
    ...
    constructor(address initialOwner) ERC20("PixelPorke", "PixelPorke") Ownable(initialOwner) {
