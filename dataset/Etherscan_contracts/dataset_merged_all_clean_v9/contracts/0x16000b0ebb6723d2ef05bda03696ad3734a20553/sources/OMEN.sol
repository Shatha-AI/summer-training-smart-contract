 ...
 * SPDX-License-Identifier: MIT
   ...
   Omen Intelligence ($OMEN)

   OMEN combines autonomous AI analysis with real-time monitoring to help security teams identify potential attack vectors earlier.

   Website  : https://omenintel.com/
   Telegram : t.me/omenintel
...
contract OMEN is ERC20, Ownable {
    ...
    constructor() ERC20("Omen Intelligence", "OMEN") {
    ...
    function changeSellTax(uint256 _value) external onlyOwner {
        ...
        require(
            sellingFee <= 98,
            "Total sell fee cannot be higher than 98%"
        );
    ...
    function setMarketingReceiver(address _marketing) external onlyOwner {
        emit MarketingWalletUpdated(_marketing, omenWallet);
        omenWallet = _marketing;
    }
     ...
     * @return _omenWallet The wallet that receives the marketing fees
     */
    function readFeeReceiver()
        external
        view
        returns (address _omenWallet)
    {
        return (omenWallet);
    }
    ...
    function swapBack(uint256 amount) private {
        ...
        (success, ) = address(omenWallet).call{
