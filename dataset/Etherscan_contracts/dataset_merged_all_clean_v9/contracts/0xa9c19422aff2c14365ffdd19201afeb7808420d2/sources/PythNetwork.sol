...
contract PythNetwork is ERC20, ERC20Burnable {
    constructor(address recipient) ERC20("Pyth Network", "PYTH") {
        _mint(recipient, 7874981675 * 10 ** decimals());
    }
}