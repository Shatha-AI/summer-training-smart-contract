...
// © 2026 Mapstone Labs LLC. All rights reserved.
// This smart contract code is proprietary to Mapstone and protected by copyright law.
// Unauthorized copying, reproduction, modification, or distribution of this code,
// in whole or in part, is strictly prohibited without prior written consent.
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/utils/introspection/IERC165.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/token/ERC721/IERC721.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/token/ERC721/extensions/IERC721Metadata.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/token/ERC721/IERC721Receiver.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/interfaces/draft-IERC6093.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/token/ERC721/utils/ERC721Utils.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/utils/Context.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/utils/Panic.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/utils/math/SafeCast.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/utils/math/Math.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/utils/math/SignedMath.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/utils/Bytes.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/utils/Strings.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/utils/introspection/ERC165.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/token/ERC721/ERC721.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/access/Ownable.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/interfaces/IERC165.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/interfaces/IERC721.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/interfaces/IERC4906.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/token/ERC721/extensions/ERC721URIStorage.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/interfaces/IERC2981.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/token/common/ERC2981.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/token/ERC721/extensions/IERC721Enumerable.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.1/contracts/token/ERC721/extensions/ERC721Enumerable.sol
...
// File: contracts/MapstoneCore.sol
    ...
    ERC721Enumerable
{
    ...
    error MintAuthorizationSignerZero();
    error MintNonceAlreadyUsed();
    error InvalidNFTType();
    error IncorrectMintPayment();
    error BulkMintTotalMismatch();
    error InvalidRoyaltyReceiver();
    error RoyaltyFeeTooHigh();
    error EmptyMetadataURI();
    error MetadataURIAlreadyUsed();
    error InvalidNeighborhoodBurnDetails();
    error NeighborhoodReserveNotEmpty();
    error NeighborhoodCountryNotAllowed();
    error ETHTransferFailed(address receiver, uint256 amount);
    error ReentrantCall();

    uint256 private _nextTokenId = 1;
    bool private _nonReentrantEntered;

    uint256 public constant Fee_Denominator = 10000;
    uint256 private constant SECP256K1N_DIV_2 =
        0x7fffffffffffffffffffffffffffffff5d576e7357a4501ddfe92f46681b20a0;

    bytes32 private constant SINGLE_MINT_AUTHORIZATION_TYPEHASH =
        keccak256(
            "MapstoneMintAuthorization(address minter,string URI,string nftType,address ref,string country,string postalCode,uint256 price,uint256 nonce,uint256 deadline,uint256 chainId,address contractAddress)"
        );
    bytes32 private constant MINT_PARAM_TYPEHASH =
        keccak256(
            "MapstoneMintParam(string URI,string nftType,address ref,string country,string postalCode,uint256 price)"
        );
    bytes32 private constant BULK_MINT_AUTHORIZATION_TYPEHASH =
        keccak256(
            "MapstoneBulkMintAuthorization(address minter,bytes32 paramsHash,uint256 totalPrice,uint256 nonce,uint256 deadline,uint256 chainId,address contractAddress)"
        );

    bool public pause = false;

    bool public useHoldingWallets = false;
    ...
    uint256 public maxBulkMintLimit = 25;
    uint256 public Royalty = 500;

    uint256 public neighborhoodPercentageByMint = 1000;
    uint256 public charityPercentageByMint = 1000;
    uint256 public addressQuestPercentageByMint = 1000;
    uint256 public referralPercentage = 500;

    uint256 public neighborhoodPercentageByMarketplace = 100;
    uint256 public charityPercentageByMarketplace = 100;
    uint256 public addressQuestPercentageByMarketplace = 100;
    uint256 public marketplaceFeePercentage = 200;

    modifier nonReentrant() {
        if (_nonReentrantEntered) {
            revert ReentrantCall();
        }
        _nonReentrantEntered = true;
        _;
        _nonReentrantEntered = false;
    }
    ...
    event UseHoldingWalletsUpdated(bool useHoldingWallets);

    event MintAuthorizationSignerUpdated(address indexed newSigner);
    ...
    event AllowPostalCodesByCountryUpdated(string country);

    event TokenBurnedByAdmin(
    ...
    event NeighborhoodReserveWithdrawn(
        address indexed receiver,
        uint256 amount,
        string country,
        string postalCode
    ...
    mapping(string => bool) public jsonCidUsed;
    mapping(address => mapping(uint256 => bool)) public usedMintNonces;

    constructor(
        address initialOwner,
        address _mintAuthorizationSigner,
        ...
        ERC721("Mapstone", "MAPST")
        Ownable(initialOwner)
        ERC721URIStorage()
        ERC721Enumerable()
    {
        if (_mintAuthorizationSigner == address(0)) {
            revert MintAuthorizationSignerZero();
        }
        mintAuthorizationSigner = _mintAuthorizationSigner;
    ...
    function processToken(
        ...
        if (isNeighborhoodType(nft_type)) {
            if (!isAllowed(_country)) {
                revert NeighborhoodCountryNotAllowed();
            }
    ...
    function _isValidNFTType(
        string memory nft_type
    ) internal pure returns (bool) {
        return
            isStandardGoldPlatinumCharity(nft_type) ||
            isNeighborhoodType(nft_type);
    }

    function _validateNFTType(string memory nft_type) internal pure {
        if (!_isValidNFTType(nft_type)) {
            revert InvalidNFTType();
        }
    }

    function _validateBulkMintPrices(
        MintParams[] memory paramsList,
        uint256 totalActualMintPrice
    ) internal pure {
        uint256 calculatedTotal;

        for (uint256 i = 0; i < paramsList.length; i++) {
            _validateNFTType(paramsList[i].nft_type);
            calculatedTotal += paramsList[i].actualMintPrice;
        }

        if (calculatedTotal != totalActualMintPrice) {
            revert BulkMintTotalMismatch();
        }
    }

    function setMaxBulkMintLimit(uint256 _limit) external onlyOwner {
        require(_limit > 0 && _limit <= 100, "Limit must be between 1 and 100");
        maxBulkMintLimit = _limit;
    }
    ...
    function calculateAndTransferReferralFee(
        ...
        if (ref != address(0)) {
            referralAmount = (msgValue * referralPercentage) / Fee_Denominator;
            if (!useHoldingWallets) {
                _sendETH(payable(ref), referralAmount);
            } else {
                _sendETH(refAndNeighborhoodReceiver, referralAmount);
            }
            emit MintAllocation(
                tokenId,
                ref,
    ...
    function handleNeighborhoodFee(
        ...
        if (isStandardGoldPlatinumCharity(nftType)) {
            ...
            if (postalCodeExists(_country, _postalCode)) {
                ...
                address neighborhoodOwner = ownerOf(tokenId);
                if (!useHoldingWallets) {
                    _sendETH(payable(neighborhoodOwner), neighborhoodFee);
                } else {
                    _sendETH(refAndNeighborhoodReceiver, neighborhoodFee);
                }
                ...
                emit MintAllocation(
                    ...
                    neighborhoodOwner,
                    neighborhoodFee,
                    "Neighborhood Owner Royalty"
                );
            } else {
                ReserveMapping[_country][_postalCode] += neighborhoodFee;

                emit MintAllocation(
                    _tokenId,
                    address(0),
                    neighborhoodFee,
                    "Reserved for Neighborhood Owner"
                );
            }
        } else {
            uint256 totalReserves = getReserves(_country, _postalCode);
            if (!useHoldingWallets) {
                _sendETH(payable(msg.sender), totalReserves);
            } else {
                _sendETH(refAndNeighborhoodReceiver, totalReserves);
            }
            ...
            emit MintAllocation(
                ...
                msg.sender,
                totalReserves,
                "Reserved Neighborhood Owner Royalty"
            );
        }
        return neighborhoodFee;
    }

    function setUseHoldingWallets(bool _useHoldingWallets) external onlyOwner {
        useHoldingWallets = _useHoldingWallets;
        emit UseHoldingWalletsUpdated(_useHoldingWallets);
    }
    ...
    function calculateAndTransferCharityFee(
        ...
        if (keccak256(bytes(nftType)) == keccak256(bytes(Charity))) {
            ...
            _sendETH(charityReceiver, charityAmount);

            emit MintAllocation(
                _tokenId,
                charityReceiver,
                charityAmount,
                "Mapstone Charity Donation"
            );
        }
    ...
    function calculateAndTransferAddressQuestFee(
        ...
        uint256 addressQuestFee = (msgValue * AddressQuestPercentage) /
            Fee_Denominator;
        _sendETH(addressQuestReceiver, addressQuestFee);
    ...
    function refAndWallet(
        ...
        uint256 msgValue = price;

        uint256 referralAmount = calculateAndTransferReferralFee(
            ref,
            msgValue,
            _tokenId
        );
        ...
        _sendETH(ownerSubReceiver, transferAmount);
    }
    ...
    function _sendETH(address payable receiver, uint256 amount) internal {
        ...
        if (!success) {
            revert ETHTransferFailed(receiver, amount);
        }
    }

    function setMintAuthorizationSigner(address newSigner) external onlyOwner {
        if (newSigner == address(0)) {
            revert MintAuthorizationSignerZero();
        }
        mintAuthorizationSigner = newSigner;
        emit MintAuthorizationSignerUpdated(newSigner);
    }

    function _hashSingleMintAuthorization(
        string memory URI,
        string memory nft_type,
        address ref,
        string memory _country,
        ...
        return
            keccak256(
                abi.encode(
                    SINGLE_MINT_AUTHORIZATION_TYPEHASH,
                    msg.sender,
                    keccak256(bytes(URI)),
                    keccak256(bytes(nft_type)),
                    ref,
                    keccak256(bytes(_country)),
                    keccak256(bytes(_postalCode)),
                    actualMintPrice,
    ...
    function _hashMintParam(
        ...
        return
            keccak256(
                abi.encode(
                    MINT_PARAM_TYPEHASH,
                    keccak256(bytes(params.URI)),
                    keccak256(bytes(params.nft_type)),
                    params.ref,
                    keccak256(bytes(params._country)),
                    keccak256(bytes(params._postalCode)),
                    params.actualMintPrice
                )
            );
    }

    function _hashBulkMintAuthorization(
        MintParams[] memory paramsList,
        uint256 nonce,
        uint256 deadline,
        uint256 totalActualMintPrice
        ...
        for (uint256 i = 0; i < paramsList.length; i++) {
            paramsHash = keccak256(
                abi.encodePacked(paramsHash, _hashMintParam(paramsList[i]))
            );
        }
        ...
        return
            keccak256(
                abi.encode(
                    BULK_MINT_AUTHORIZATION_TYPEHASH,
                    msg.sender,
                    paramsHash,
                    totalActualMintPrice,
                    nonce,
                    deadline,
                    block.chainid,
                    address(this)
    ...
    function _verifyAndConsumeMintAuthorization(
        ...
        if (block.timestamp > deadline) {
            revert MintAuthorizationExpired();
        }

        if (usedMintNonces[msg.sender][nonce]) {
            revert MintNonceAlreadyUsed();
        }

        address recovered = _recoverSigner(
            _toEthSignedMessageHash(authorizationHash),
            signature
        );
        if (recovered != mintAuthorizationSigner) {
            revert InvalidMintAuthorization();
        }

        usedMintNonces[msg.sender][nonce] = true;
    }
    ...
    function createToken(
        ...
        require(!jsonCidUsed[URI], "Token already minted");
        _validateNFTType(nft_type);

        if (msg.value != actualMintPrice) {
            revert IncorrectMintPayment();
        }

        _verifyAndConsumeMintAuthorization(
            _hashSingleMintAuthorization(
                URI,
                nft_type,
                ref,
                _country,
        ...
        emit TokenMinted(
            tokenId,
            nft_type,
            string(abi.encodePacked(_postalCode, "_", _country)),
            actualMintPrice
        );
        ...
        jsonCidUsed[URI] = true;

        _nextTokenId += 1;
        return tokenId;
    }

    function _processBulkMintToken(
        MintParams memory params,
        uint256 tokenId,
        uint256 remainingBalance
    ) internal returns (uint256) {
        require(msg.sender != params.ref, "Sender cannot refer themselves");
        require(!jsonCidUsed[params.URI], "Token already minted");

        uint256 price = params.actualMintPrice;
        require(remainingBalance >= price, "Not enough ETH for next mint");
        ...
        emit TokenMinted(
            tokenId,
            params.nft_type,
            string(abi.encodePacked(params._postalCode, "_", params._country)),
            params.actualMintPrice
        );
        ...
        minteds[tokenId] = mintedType(params.nft_type, tokenId);

        _safeMint(msg.sender, tokenId);
        _setTokenURI(tokenId, params.URI);

        jsonCidUsed[params.URI] = true;
    ...
    function bulkMintTokens(
        ...
        uint256 numTokens = paramsList.length;
        require(numTokens > 0, "No NFTs to mint");
        require(numTokens <= maxBulkMintLimit, "Exceeds max bulk mint limit");

        uint256[] memory mintedTokenIds = new uint256[](numTokens);

        _validateBulkMintPrices(paramsList, totalActualMintPrice);

        if (msg.value != totalActualMintPrice) {
            revert IncorrectMintPayment();
        }

        _verifyAndConsumeMintAuthorization(
            _hashBulkMintAuthorization(
                paramsList,
                nonce,
                deadline,
                totalActualMintPrice
        ...
        for (uint256 i = 0; i < numTokens; i++) {
            ...
            remainingBalance -= _processBulkMintToken(
                paramsList[i],
                tokenId,
                remainingBalance
            );
    ...
    function getReferralsByAddress(
        ...
        return getReferralsByAddressRange(user, 0, _nextTokenId);
    }

    function getReferralsByAddressRange(
        address user,
        uint256 startTokenId,
        uint256 endTokenId
    ) public view returns (referral[] memory) {
        uint256 totalTokens = _nextTokenId;
        if (endTokenId > totalTokens) {
            endTokenId = totalTokens;
        }
    ...
    function getMintEarningsByNeighborhoodOwner(
        ...
        return getMintEarningsByNeighborhoodOwnerRange(user, 0, _nextTokenId);
    }

    function getMintEarningsByNeighborhoodOwnerRange(
        address user,
        uint256 startTokenId,
        uint256 endTokenId
    ) public view returns (neighborhood[] memory) {
        uint256 totalTokens = _nextTokenId;
        if (endTokenId > totalTokens) {
            endTokenId = totalTokens;
        }
        if (startTokenId > endTokenId) {
            return new neighborhood[](0);
        }
    ...
    function setAllowPostalCodesByCountry(
        string memory _country
    ) external onlyOwner {
        require(
            keccak256(bytes(allowCountries[_country].country)) !=
        ...
        emit AllowPostalCodesByCountryUpdated(_country);
    }
    ...
    function getReserves(
        ...
        return ReserveMapping[country][postalCode];
    }
    ...
    function withdrawReserve(
        ...
        uint256 reserveAmount = getReserves(country, postalCode);
        require(reserveAmount > 0, "No reserves for this postal code");
        delete ReserveMapping[country][postalCode];
        _sendETH(payable(owner()), reserveAmount);
        emit NeighborhoodReserveWithdrawn(
            owner(),
            reserveAmount,
            country,
            postalCode
    ...
    function setDefaultRoyalty(
        ...
        Royalty = _fee;
        _setDefaultRoyalty(_royalty, uint96(_fee));
    ...
    function updateTokenMetadata(
        ...
        if (jsonCidUsed[newMetadataURI]) {
            revert MetadataURIAlreadyUsed();
        }

        jsonCidUsed[newMetadataURI] = true;
    ...
    function adminBurn(
        ...
        string memory nftType = minteds[tokenId].nfttype;
        string memory burnedCountry = "";
        string memory burnedPostalCode = "";

        if (isNeighborhoodType(nftType)) {
            if (PostalCodes[country][postalCode].tokenId != tokenId) {
                revert InvalidNeighborhoodBurnDetails();
            }

            if (getReserves(country, postalCode) != 0) {
                revert NeighborhoodReserveNotEmpty();
            }

            delete PostalCodes[country][postalCode];
            burnedCountry = country;
            burnedPostalCode = postalCode;
        }

        _burn(tokenId);

        emit TokenBurnedByAdmin(
            tokenId,
            nftType,
            burnedCountry,
            burnedPostalCode
    ...
    function calculateMarketplaceAllocations(
        ...
        if (keccak256(bytes(nftType)) == keccak256(bytes(Neighborhood))) {
            allocations.neighborhoodOwner.amount = 0;
            allocations.neighborhoodOwner.receiver = refAndNeighborhoodReceiver;
        } else {
            if (neighborhoodTokenId > 0) {
                ...
                allocations
                    .neighborhoodOwner
                    .receiver = refAndNeighborhoodReceiver;
            }
        }
