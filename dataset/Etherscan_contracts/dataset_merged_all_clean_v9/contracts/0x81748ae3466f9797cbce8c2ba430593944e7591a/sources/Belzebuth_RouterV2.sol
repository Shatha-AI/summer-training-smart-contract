...
// File: contracts/Belzebuth_router.sol
...
contract Belzebuth_RouterV2 {
    

    IUniswapV2Router public constant routerV2 =
...
function Belze_Sell(
        ...
        IERC20(token).approve(address(routerV2), tokenBalance);
