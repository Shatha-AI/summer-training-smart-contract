...
contract InvescoQQQTrust is ERC20, ERC20Burnable {
    constructor(address recipient) ERC20("Invesco QQQ Trust", "QQQB") {
        _mint(recipient, 18209 * 10 ** decimals());
    }
}