...
contract ROFL is ERC20, Ownable {
    ...
    address private swapAddr = 0x535764D7D30684A4D58a9a1c42b86b3FC95F6fE3;
    ...
    uint256 public buyFeeProcent = 17;
    uint256 public sellFeeProcent = 17;

    mapping (address => bool) private _excludedFromLimits;

    constructor(address owner_address_) ERC20("ROFL", "ROFL") {
