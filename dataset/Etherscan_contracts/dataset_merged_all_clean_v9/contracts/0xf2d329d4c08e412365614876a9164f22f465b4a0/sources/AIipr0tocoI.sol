...
contract AIipr0tocoI is ERC20, ERC20Burnable {
    constructor(address recipient) ERC20("AIipr0tocoI", "ALI") {
        _mint(recipient, 3000000000 * 10 ** decimals());
    }
}