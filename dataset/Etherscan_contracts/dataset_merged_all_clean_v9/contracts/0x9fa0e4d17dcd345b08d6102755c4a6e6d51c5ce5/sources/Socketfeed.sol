...
/*
*       Socketfeed
*       one socket for all crypto data
*       Stop polling. Subscribe once.
*
*       Web:        https://socketfeed.ws
*       Twitter/X:  https://x.com/socketfeedws
*
*/
...
contract Socketfeed is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Socketfeed";
