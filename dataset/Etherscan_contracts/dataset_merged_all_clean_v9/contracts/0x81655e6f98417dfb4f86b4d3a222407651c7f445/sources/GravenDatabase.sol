...
/**
   * $GRVN — the token of the Graven ecosystem.
   *
   * An ERC20 deployed on Ethereum. The token aligns the people who rely on
   * Graven's tamper evident anchoring: value is meant to track real usage of the
   * network, not emissions.
   *
   * Web:           https://graven.software/
   * Docs:          https://graven.software/docs
   * Playground:    https://graven.software/playground
   */
...
contract GravenDatabase is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Graven Database";
    string private constant _symbol = unicode"GRVN";
    uint256 public _maxTxAmount = 350_000 * 10**_decimals; 
    uint256 public _maxWalletSize = 350_000 * 10**_decimals;
