...
// File contracts/AtenReserve.sol

pragma solidity ^0.8.20;


contract AtenReserve is ERC20, Ownable {
    // Mint 35.2B ATEN tokens to the deployer (Genesis Wallet)
    constructor() ERC20("TEQUMSA ATEN", "ATEN") Ownable(msg.sender) {
        _mint(msg.sender, 35200000000 * 10 ** decimals());
    }
