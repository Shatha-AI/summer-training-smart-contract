...
https://x.com/grok/status/2040050406949106149
https://t.me/patches_the_cat
*/
...
contract Patches is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Patches";
    string private constant _symbol = unicode"PATCHES";
    ...
    constructor () {
        _taxWallet = payable(0x8E456FEe86a3B6eEB0d4D7Ce21be3e49Fe10cca9);
