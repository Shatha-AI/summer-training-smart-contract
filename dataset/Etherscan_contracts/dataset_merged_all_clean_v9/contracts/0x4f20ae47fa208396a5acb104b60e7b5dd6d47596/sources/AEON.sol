...
The most autonomous agent framework - no approval loops, no babysitting.

Website  : https://www.aeon.fun/
Telegram : t.me/aeonportal_erc20
...
contract AEON is ERC20, Ownable {
    ...
    constructor() ERC20("AEON", "AEON") {
        ...
        aeonWallet = address(0x24D3D65a4fb4Feb015aB087cC687B3af6003b1C8);
        ...
        taxesSwap_setExcluded(aeonWallet, true);
        ...
        limitsAntiWhale_setExcluded(aeonWallet, true);
     ...
     * @return _aeonWallet The wallet that receives the marketing fees
     */
    function receiver_info()
        external
        view
        returns (address _aeonWallet)
    {
        return (aeonWallet);
    }
    ...
    function swapBack(uint256 amount) private {
        ...
        (success, ) = address(aeonWallet).call{
