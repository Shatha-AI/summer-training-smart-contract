...
/*
X : https://x.com/brainletmeme_
WB: http://www.brainlet.lol
TG: https://t.me/brainletmeme_portal
*/
...
contract Brainlet is Context, IERC20, Ownable {
    ...
    function removeLimits_FFF() external onlyOwner{
    ...
    function openTrading_FFF() external onlyOwner() {
