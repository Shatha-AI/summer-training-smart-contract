 ...
 *
 * @dev Implementation of the a standard token.
 * @dev https://github.com/ethereum/EIPs/issues/20
 */
contract StandardToken is ERC20 {

    // Add a constructor to initialize with the initial supply
...
contract BNBTigerMerc is StandardToken, Ownable {
    constructor() StandardToken("BNBTiger Merc 3", "BNBTigerM3", 10000000000, 18) Ownable(msg.sender) {}
}

// File: contracts/ERC20JB.sol
...
contract ERC20JB is StandardToken, Ownable, AutomationCompatibleInterface {
    address public constant DEAD = 0x000000000000000000000000000000000000dEaD;
    uint256 public immutable startTime;
    uint256 public immutable endTime;

    constructor() StandardToken("ERC20 JB", "E2JB", 2100000000, 18) Ownable(msg.sender) {
