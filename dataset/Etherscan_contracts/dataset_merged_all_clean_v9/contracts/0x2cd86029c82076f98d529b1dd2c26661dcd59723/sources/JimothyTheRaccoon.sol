...
contract JimothyTheRaccoon is ERC20, ERC20Burnable {
    constructor(address recipient) ERC20("Jimothy The Raccoon", "JIMOTHY") {
        _mint(recipient, 999944533 * 10 ** decimals());
    }
}