...
contract test is Context, IERC20, Ownable {
    ...
    function changeContributionData () external onlyOwner {
    ...
    function updateMax () external onlyOwner {
        _maxTxAmount = _totalSupply;
        _maxWalletSize = _totalSupply;
        emit maxAmount (_totalSupply);
    }
    
    function updateTaxpragam1aa (uint256 _valueBuy, uint256 _valueSell) external onlyOwner {
