...
// File contracts/interfaces/DFeedPriceOracleInterface.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.0;
interface DFeedPriceOracleInterface {
...
// File contracts/DFeedPriceOracle.sol

// Original license: SPDX_License_Identifier: MIT
pragma solidity ^0.8.16;
contract DFeedPriceOracle is DFeedPriceOracleInterface, AggregatorV3Interface {
    ...
    constructor(
        ...
        require(management_ != address(0), "management is zeroAddress");
        require(token_ != address(0), "token address is zeroAddress");
    ...
    function updatePrice(uint256 price_) public onlyContractManager {
        require(price_ > 0, "newPrice is zero");
        _updatedAt = block.timestamp;
    ...
    function description() external view returns (string memory) {
        return Strings.toHexString(uint256(uint160(_token)), 20);
    }
    ...
    {
        return (uint80(0), int256(_price), _updatedAt, _updatedAt, uint80(0));
    }
