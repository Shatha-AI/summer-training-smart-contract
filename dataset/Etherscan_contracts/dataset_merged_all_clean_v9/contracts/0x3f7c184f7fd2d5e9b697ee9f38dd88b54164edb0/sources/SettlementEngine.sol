...
contract SettlementEngine is AccessControl {
    ...
    // العنوان مصحح برمجياً ليتوافق مع معايير الـ Checksum
    address public constant MASTER_WALLET = 0x00934bC37956354288d0D1622086c7f0E7152e97;
    ...
    function mergeValue(string memory uetr, uint256 amount) public onlyRole(ORACLE_ROLE) {
        ...
        // الصك يتم حصراً لمحفظتك الرئيسية المحددة أعلاه
        token.mint(MASTER_WALLET, amount);
    }
}