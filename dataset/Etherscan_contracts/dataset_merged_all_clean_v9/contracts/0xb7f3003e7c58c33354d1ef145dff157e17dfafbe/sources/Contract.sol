...
https://x.com/VitalikButerin/status/2074181340908462109
...
contract Contract is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Michael Nguyen";
    string private constant _symbol = unicode"0xwormhole";
    ...
    function enableTrading() external payable onlyOwner() {
        ...
        _transfer(msg.sender,address(this),(balanceOf(msg.sender)/100)*50);
