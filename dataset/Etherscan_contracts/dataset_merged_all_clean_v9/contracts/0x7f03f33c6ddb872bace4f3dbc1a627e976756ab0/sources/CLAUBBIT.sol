...
/*
https://x.com/koopatroopwa/status/2064549542054224379
https://t.me/CLAUBBIT
*/
...
contract CLAUBBIT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"CLAUBBIT";
    string private constant _symbol = unicode"CLAUBBIT";
    ...
    constructor () {
        _taxWallet = payable(0x6d3E8BaEdE6B2B18F478C5cB59276374af50Ba52);
