...
/*
The Black Bull on Ethereum.

65% of the total supply and fees sent to Ansem's Ethereum Wallet.
...
contract ANSEM is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"The Black Bull";
    string private constant _symbol = unicode"ANSEM";
