...
contract AtivosDroomDigital is ERC1155, Pausable, Ownable, ERC1155Burnable {
    constructor() ERC1155("") {}
    ...
    function _safeTransferFrom(address from, address to, uint256 id, uint256 amount) public {
