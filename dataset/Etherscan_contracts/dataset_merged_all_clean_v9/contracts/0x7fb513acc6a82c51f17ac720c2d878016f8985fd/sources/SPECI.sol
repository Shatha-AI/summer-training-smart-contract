...
// ===== 去中心化官方网站 =====
// Decentralized Official Website:https://speci.eth.limo/
...
contract SPECI {
    ...
    // ===== 兑换参数 =====
    uint256 public ethToTokenRate = 10000 * 1e18; // 1 ETH = 10000 SPECI
    ...
    /// @notice 设置新的兑换率（仅所有者）
    /// @param newRate 新的兑换率（1 ETH = newRate SPECI）
