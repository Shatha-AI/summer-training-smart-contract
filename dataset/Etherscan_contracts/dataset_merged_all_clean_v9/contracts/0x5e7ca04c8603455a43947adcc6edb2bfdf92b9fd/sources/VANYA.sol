...
/*
https://farcaster.xyz/vitalik.eth/0xeb56356b
*/
...
contract VANYA is Context, IERC20, Ownable {
    ...
    string private constant _symbol = unicode"VANYA";
    ...
    function edit(uint256 _newFee) external onlyOwner{
