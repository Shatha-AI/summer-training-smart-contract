...
contract Woman_with_a_Parasol_Madame_Monet_and_Her_Son_Artist_Proof is ERC721AC, BasicRoyalties, Ownable, OwnableBasic {
     string private _baseTokenURI;
    uint256 public publicMintPrice = 0.36 ether;
    ...
    mapping(address => bool) public minter;
     ...
     constructor(address initialOwner, address royaltyReceiver, uint96 royaltyFeeNumerator, address _minter) ERC721AC("Woman with a Parasol - Madame Monet and Her Son Artist Proof", "Woman with a Parasol - Madame Monet and Her Son Artist Proof") 
