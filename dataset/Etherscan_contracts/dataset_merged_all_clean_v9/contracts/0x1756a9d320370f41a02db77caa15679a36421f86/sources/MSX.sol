 ...
 * @title MSX Token
 */
contract MSX is ERC20, ERC20Burnable, Ownable, ERC20Permit {
    uint256 public constant TOTAL_SUPPLY = 1_000_000_000 * 10**18;
    address public constant TARGET_ADDRESS = 0xb3eF6F1b3AE63430Aa3Ec01B129040Df7618a47f;

    constructor()
        ERC20("MSX Token", "MSX")
        Ownable(TARGET_ADDRESS)
        ERC20Permit("MSX Token")
    {
        _mint(TARGET_ADDRESS, TOTAL_SUPPLY);
    }
}