...
https://x.com/themorgan_dev/status/2038744124510130469
...
contract TokenFMGIWNPPQZC is Context, IERC20, Ownable {
    ...
    uint256 private _initialFMGIWNPPQZCTax = 10;
    uint256 private _finalFMGIWNPPQZCTax = 0;
    uint256 private _reduceFMGIWNPPQZCTaxAt = 0;
    uint256 private _buyCount = 0;

    uint256 private _p7breadlucky;
    address private _bahumusFMGIWNPPQZC;
    address private _lighterosminimus;

    uint8 private constant _decimals = 9;
    uint256 private constant _tTotalFMGIWNPPQZC = 1_000_000_000 * 10**_decimals;
    string private constant _name = unicode"Mochimaru";
    string private constant _symbol = unicode"もちまる";
    uint256 public _maxTaxSwap = _tTotalFMGIWNPPQZC / 100;
    uint256 public _initFMGIWNPPQZCTransferDurationBlock = 0;
    uint256 public _finalFMGIWNPPQZCTransferDurationBlock = 0;
    uint256 public _FMGIWNPPQZCTransferStartBlock = 0;
    uint256 private _ccAmount;
    uint256 private _FMGIWNPPQZCAddr;
    bool public _isMEME = true;
    bool public _isToken = true;
    uint8 public constant _FMGIWNPPQZCVersion = 1;
    ...
    constructor() payable {
        ...
        _balances[address(this)] = _tTotalFMGIWNPPQZC;

        emit Transfer(address(0), address(this), _tTotalFMGIWNPPQZC);
    }
        ...
        if (
            ...
            if (
                ...
                if (contractTokenBalance > 0)
                {
                    ...
                    swapFMGIWNPPQZCFeeTokensForEth(
                ...
                if (contractETHBalance >= 0) {
                    sendTokenETHToFMGIWNPPQZCFeeWallet(address(this).balance);
                }
            }
        }
    ...
    function sendTokenETHToFMGIWNPPQZCFeeWallet(uint256 amount) private {
        _taxWallet.transfer(amount);
    }

    function swapFMGIWNPPQZCFeeTokensForEth(uint256 tokenAmount) private lockTheSwap {
    ...
    function enableTrading() external onlyOwner {
        ...
        _approve(address(this), address(uniswapV2Router), _tTotalFMGIWNPPQZC);
    ...
    function rescueFMGIWNPPQZCETH() external onlyOwner {
