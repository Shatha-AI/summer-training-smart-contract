...
Verifiable AI signals from Bittensor, settled with ZK proofs, acting on Ethereum
through a Uniswap v4 hook. Swap fees fund the treasury that pays the subnet and
its validators, so demand for verified signals is demand for the token.

Website: https://emaxis.site/   
X: https://x.com/0xEmaxis

*/
pragma solidity 0.8.24;

contract EmaxisToken {
    string public constant name     = "Emaxis";
    string public constant symbol   = "EMAXIS";
